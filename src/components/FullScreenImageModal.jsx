...
import { FaArrowLeft, FaSearchPlus, FaSearchMinus, FaRegStar, FaRegSmile, FaSearch, FaCopy } from "react-icons/fa";
      ...
      <div className="fullscreen-image-modal-overlay">
        <div className="fullscreen-image-modal">
          ...
          <div className="full-screen-modal-content">
            <img src={image} alt="Full View" className="fullscreen-image" />
          </div>
